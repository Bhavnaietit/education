...
const AddCourse = () => {
	...
	const { allCourses, backendUrl, getToken } = useContext(AppContext);
			...
			<form
				...
				<div className="flex flex-col p-4">
					...
					<input
						...
						className="border border-gray-400 rounded-sm h-10 p-2"
				...
				<div className="flex justify-between">
					<div className="flex flex-col p-4">
						<label className="text-gray-500">Course Price</label>
						<input
							type="number"
							value={coursePrice}
							onChange={(e) => {
							...
							required
							className="outline-none md:py-2.5 py-2 w-28 px-3 border border-gray-400 rounded-sm h-10 p-2"
						...
						<label className="text-gray-500 ">
							...
							<div className="flex gap-4">
								<img
									...
									className="p-3 bg-blue-500 rounded w-fit"></img>
								<input
									type="file"
									onChange={(e) => {
				...
				<div>
							...
							<div className="flex justify-between items-center p-4 border-b">
								<div className="flex items-center">
									<img
										...
										width={14}
										className={`mr-2 cursor-pointer translate-all ${
					...
					<div
						className="inline-flex w-full justify-center items-center bg-gray-300 p-2 rounded cursor-pointer mt-2"
						onClick={() => {
							handleChapter("add");
						}}>
						+Add Chapter
